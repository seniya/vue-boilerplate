<template>
  <a-card hoverable style="width: 100%" :loading="isLoadingLetterRead">
    <a-form
      :form="form"
      :label-col="{ span: 5 }"
      :wrapper-col="{ span: 12 }"
...
export default {
  ...
  watch: {
    item: function () {
      if (!this.isLoadingLetterRead) this.cdSetFieldsValueWithAntd()
    }
  },
